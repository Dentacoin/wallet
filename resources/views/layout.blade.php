...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.0.11">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.0.11">
...
<body class="@if(!empty(Route::current())) {{Route::current()->getName()}} @else class-404 @endif" @if(isset($dcn_in_usd)) data-current-dcn-in-usd="{{$dcn_in_usd}}" @endif>
    ...
    <script src="/dist/js/front-libs-script.js?v=1.0.31"></script>
    <script src="/assets/js/basic.js?v=1.0.17"></script>
    @yield("script_block")
    {{--<script src="/dist/js/front-script.js"></script>--}}
    <script src="/assets/js/index-compiled.js?v=1.1.73"></script>
</body>
</html>