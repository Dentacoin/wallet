            ...
            <div class="container">
                <div class="row-flex">
                    <div class="col-12 text-center">
                        ...
                        <div class="address">
                            <figure class="inline-block" itemscope="" itemtype="http://schema.org/ImageObject"><a href="javascript:void(0)" class="copy-address" data-toggle="tooltip" title="Copied." onclick="copyToClipboard('.important-message')"><img src="{{URL::asset('assets/images/copy.svg') }}" class="Copy address to clipboard icon" itemprop="contentUrl"/></a></figure>
